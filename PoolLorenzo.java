package com.mycompany.poollorenzo;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class PoolLorenzo extends JPanel implements ActionListener, MouseMotionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ((paloX + 100 >= pelotaX1 && paloX <= pelotaX1 + 30) &&
            ...
            pelotaDX1 = -pelotaDX1;
            pelotaDY1 = -pelotaDY1; // Cambié la dirección vertical
        }

        if ((paloX + 100 >= pelotaX2 && paloX <= pelotaX2 + 30) &&
            (paloY + 20 >= pelotaY2 && paloY <= pelotaY2 + 30)) {
            pelotaDX2 = -pelotaDX2;
            pelotaDY2 = -pelotaDY2; // Cambié la dirección vertical
        }
    ...
    public void mouseMoved(MouseEvent e) {
        // Actualizar la posición del palo con el movimiento del ratón
        paloX = e.getX() - 50;
        paloY = e.getY() - 10; // Ajusté la posición Y para centrar el palo horizontal
        repaint();
    }
    ...
    public static void main(String[] args) {
        ...
        PoolLorenzo PoolLorenzo = new PoolLorenzo();
        frame.add(PoolLorenzo);
